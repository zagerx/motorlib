...
static void pwm_stm32_start(const struct device *dev)
{
	...
	LL_TIM_CC_EnableChannel(cfg->timer, LL_TIM_CHANNEL_CH1 | LL_TIM_CHANNEL_CH2 |
...
static int pwm_stm32_init(const struct device *dev)
{
	...
	LL_TIM_InitTypeDef tim_init = {.CounterMode = LL_TIM_COUNTERMODE_CENTER_UP,
	...
	LL_TIM_OC_InitTypeDef tim_ocinit = {.OCMode = LL_TIM_OCMODE_PWM1,
	...
	LL_TIM_BDTR_InitTypeDef brk_dt_init = {.OSSRState = LL_TIM_OSSR_DISABLE,
